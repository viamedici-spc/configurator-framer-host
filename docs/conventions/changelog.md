...
This convention defines changelog creation for the **Configurator Framer Host** library (a JavaScript/TypeScript package).
...
- Target audience: host application developers embedding the configurator. Avoid overly technical or internal-only details.
